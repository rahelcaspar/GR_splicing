#DEXSeq (public data - dex vs control, ZT12)
...
sample_conditions <- sample_conditions[(sample_conditions$timepoint == "ZT12"),]
...
#save results
save("dxd", file = "/nfs/proj/gr_splicing/Ergebnisse_public_data/dexseq/public_data_dexseq-dataset_dex12.RData")
save("dxresult", file = "/nfs/proj/gr_splicing/Ergebnisse_public_data/dexseq/public_data_dexseq_result_dex12.RData")


#visualization
#create html report
DEXSeqHTML(dxresult, FDR = 0.05, color=c("#FF000080", "#0000FF80"), path = "/nfs/proj/gr_splicing/Ergebnisse_public_data/dexseq/DEXSeqReport_dex12")


#MA plot
png("/nfs/proj/gr_splicing/Ergebnisse_public_data/dexseq/plotMA_dex12.png")
