#DEXSeq (public data - dex vs control, both timepoints (ZT00 & ZT12))
...
#save results
save("dxd", file = "/nfs/proj/gr_splicing/Ergebnisse_public_data/dexseq/public_data_dexseq-dataset_dex.RData")
save("dxresult", file = "/nfs/proj/gr_splicing/Ergebnisse_public_data/dexseq/public_data_dexseq_result_dex.RData")


#visualization
#MA plot
png("/nfs/proj/gr_splicing/Ergebnisse_public_data/dexseq/plotMA_dex.png")
plotMA(dxresult, alpha = 0.05)
dev.off()


#create html report
DEXSeqHTML(dxresult, FDR = 0.05, color=c("#FF000080", "#0000FF80"), path = "/nfs/proj/gr_splicing/Ergebnisse_public_data/dexseq/DEXSeqReport_dex")
