#load output data from whippet delta (public ko)  |  A = KO, B = WT
...
png(filename = "/nfs/proj/gr_splicing/Ergebnisse_public_data/whippet-plots/public_ko_diff_volcano-plot.png", width = 1000, height = 800)
par(mar=c(5, 5, 4, 8), xpd=TRUE)

plot(file_diff$DeltaPsi, file_diff$Probability, pch = 20, main = "Liver (KO vs WT) AS Events Volcano Plot", xlab = "DeltaPsi", ylab = "Probability", cex.main=1.5, cex.lab=1.3)
