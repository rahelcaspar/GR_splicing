#load output data from whippet delta (hepatocytes dex)  |  A = dex, B = control
...
png(filename = "/nfs/proj/gr_splicing/Ergebnisse_new_data/whippet-plots/new_data_diff_volcano-plot.png", width = 1000, height = 800)
par(mar=c(5, 5, 4, 8), xpd=TRUE)

plot(file_diff$DeltaPsi, file_diff$Probability, pch = 20, main = "Hepatocytes (Dex vs Control) AS Events Volcano Plot", xlab = "DeltaPsi", ylab = "Probability", cex.main=1.5, cex.lab=1.3)
